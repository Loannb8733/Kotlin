...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //verification que les permissions sont données
        if (askForPermissions()) isPermissionAllowed()
        else showPermissionDeniedDialog()

        //bouton permettant de choisir une photo dans la gallerie
        val btnChoisirDansGallerie = findViewById<Button>(R.id.btnChoisirDansGallerie)
        ...
        val btnPrendrePhoto = findViewById<Button>(R.id.btnPrendrePhoto)
